 ...
 * <p>
 * Using the methods {@link PortRanges#fromInteger(Integer)}, {@link PortRanges#fromString(String)} and
 * {@link PortRanges#fromCollection(Collection)} this is adaptable from a number, a string, or a collection
 * of numbers or strings. String may be of the form:
 * <ul>
 *   <li> "80": just 80
 ...
 * 
 * @see {@link brooklyn.location.basic.PortRanges}
 */
