...
public class ScheduledExecutionTest {
    ...
    public void testScheduledTask() {
        ...
        int i=0;
        def t = new ScheduledTask(delay: 2*PERIOD, period: PERIOD, maxIterations: 5, { new BasicTask({
    ...
    public void testScheduledTaskSelfEnding() {
        ...
        BasicExecutionManager m = new BasicExecutionManager();
        int i=0;
        def t = new ScheduledTask(delay: 2*PERIOD, period: PERIOD, { new BasicTask({
...
//        assertEquals(finalResult, 5)
    ...
    public void testScheduledTaskTakesLongerThanPeriod() {
        ...
        def t = new ScheduledTask(delay: PERIOD, period: PERIOD:, { new BasicTask({
