...
/**
 * Entry point for wiring up brooklyn attributes to JMX.
 * <p>
 * This doesn't evaluate any sensors directly, but provides support for specific
 * object-name/attribute combos etc.
 * <p>
 * Example usage:
 * <pre>
 * {@code
 ...
 * </pre>
 *
 * @deprecated Since 0.5.0; Use {@link brooklyn.event.feed.jmx.JmxFeed}
 */
@Deprecated
public class JmxSensorAdapter extends AbstractSensorAdapter {
    ...
    static {
        // JMX ClientCommunicatorAdmin spits out scary warnings, but we just retry so don't worry
