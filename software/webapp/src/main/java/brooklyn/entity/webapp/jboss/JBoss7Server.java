...
public interface JBoss7Server extends JavaWebAppSoftwareProcess, JavaWebAppService, HasShortName {
    ...
    @SetFromFlag("version")
    ConfigKey<String> SUGGESTED_VERSION = new BasicConfigKey<String>(SoftwareProcess.SUGGESTED_VERSION, "7.1.1.Final");
    ...
    BasicAttributeSensorAndConfigKey<String> BIND_ADDRESS = new BasicAttributeSensorAndConfigKey<String>(
            "jboss.bind.address",
    ...
    PortAttributeSensorAndConfigKey MANAGEMENT_HTTP_PORT = new PortAttributeSensorAndConfigKey(
    ...
    PortAttributeSensorAndConfigKey MANAGEMENT_HTTPS_PORT = new PortAttributeSensorAndConfigKey(
            "webapp.jboss.managementHttpsPort", "Management port", "9443+");

    @SetFromFlag("managementNativePort")
    PortAttributeSensorAndConfigKey MANAGEMENT_NATIVE_PORT = new PortAttributeSensorAndConfigKey(
    ...
    BasicAttributeSensorAndConfigKey<Integer> PORT_INCREMENT = new BasicAttributeSensorAndConfigKey<Integer>(
            "webapp.jboss.portIncrement", "Port increment, for all ports in config file", 0);

    @SetFromFlag("deploymentTimeout")
    BasicAttributeSensorAndConfigKey<Integer> DEPLOYMENT_TIMEOUT = new BasicAttributeSensorAndConfigKey<Integer>(
    ...
    AttributeSensor<Integer> MANAGEMENT_STATUS = new BasicAttributeSensor<Integer>("webapp.jboss.managementStatus", "HTTP response code for the management server");
}
