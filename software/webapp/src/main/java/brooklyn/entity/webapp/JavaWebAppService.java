...
public interface JavaWebAppService extends WebAppService, UsesJava {
	...
	@SetFromFlag("war")
    ConfigKey<String> ROOT_WAR = new BasicConfigKey<String>("wars.root",
            "WAR file to deploy as the ROOT, as URL (supporting file: and classpath: prefixes)");

    // TODO replace with ListConfigKey<String>
    @SetFromFlag("wars")
    ConfigKey<List<String>> NAMED_WARS = new BasicConfigKey<List<String>>("wars.named",
    ...
    ConfigKey<Map<String,String>> WARS_BY_CONTEXT = new BasicConfigKey<Map<String,String>>("wars.by.context",
