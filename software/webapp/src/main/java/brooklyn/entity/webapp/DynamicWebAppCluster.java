...
public interface DynamicWebAppCluster extends DynamicCluster, WebAppService {
    ...
    AttributeSensor<Double> REQUEST_COUNT_PER_NODE = Attributes.newAttributeSensor("webapp.reqs.total.perNode", "Cluster entity request average");
    ...
    AttributeSensor<Integer> ERROR_COUNT_PER_NODE = Attributes.newAttributeSensor("webapp.reqs.errors.perNode", "Cluster entity request error average");
    ...
    AttributeSensor<Integer> AVERAGE_ERROR_COUNT = ERROR_COUNT_PER_NODE;
