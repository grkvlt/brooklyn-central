...
class GangliaClusterEc2LiveTest {
    protected static final Logger LOG = LoggerFactory.getLogger(GangliaClusterEc2LiveTest.class)
    ...
    public void setUp() {
        ...
        loc.setTagMapping([(GangliaManager.class.getName()):[
            imageId:imageId,
    ...
    public void canStartupAndShutdown() {
        cluster = new GangliaCluster(owner:app, initialSize:2, clusterName:'Amazon Cluster');
        app.start([ loc ])
