...
public class BrooklynWebConfig {
    ...
    public final static ConfigKey<String> SECURITY_PROVIDER_CLASSNAME = new BasicConfigKey<String>(
     ...
     */
    public final static ConfigKey<String> SECURITY_PROVIDER_EXPLICIT__USERS = new BasicConfigKey<String>(
            BASE_NAME+".security.explicit.users");

    public final static ConfigKey<String> LDAP_URL = new BasicConfigKey<String>(BASE_NAME+".security.ldap.url");

    public final static ConfigKey<String> LDAP_REALM = new BasicConfigKey<String>(BASE_NAME+".security.ldap.realm");

    public final static ConfigKey<String> SECURITY_PROVIDER_EXPLICIT__PASSWORD(String user) {
        return new BasicConfigKey<String>(BASE_NAME+".security.explicit.user."+user);
    }
