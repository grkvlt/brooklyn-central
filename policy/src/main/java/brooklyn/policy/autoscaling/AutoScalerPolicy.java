...
public class AutoScalerPolicy extends AbstractPolicy {
    ...
    @SetFromFlag("metric")
    public static final ConfigKey<AttributeSensor<? extends Number>> METRIC = BasicConfigKey.<AttributeSensor<? extends Number>>builder()
            .name("autoscaler.metric")
            .build();

    @SetFromFlag("entityWithMetric")
    public static final ConfigKey<Entity> ENTITY_WITH_METRIC = BasicConfigKey.<Entity>builder()
            .name("autoscaler.entityWithMetric")
            .build();

    @SetFromFlag("metricLowerBound")
    public static final ConfigKey<Number> METRIC_LOWER_BOUND = BasicConfigKey.<Number>builder()
            .name("autoscaler.metricLowerBound")
            .reconfigurable(true)
            .build();

    @SetFromFlag("metricUpperBound")
    public static final ConfigKey<Number> METRIC_UPPER_BOUND = BasicConfigKey.<Number>builder()
            .name("autoscaler.metricUpperBound")
            .reconfigurable(true)
            .build();

    @SetFromFlag("minPeriodBetweenExecs")
    public static final ConfigKey<Long> MIN_PERIOD_BETWEEN_EXECS = BasicConfigKey.<Long>builder()
            .name("autoscaler.minPeriodBetweenExecs")
            .defaultValue(100L)
            .build();

    @SetFromFlag("resizeUpStabilizationDelay")
    public static final ConfigKey<Long> RESIZE_UP_STABILIZATION_DELAY = BasicConfigKey.<Long>builder()
    ...
    public static final ConfigKey<Long> RESIZE_DOWN_STABILIZATION_DELAY = BasicConfigKey.<Long>builder()
    ...
    public static final ConfigKey<Integer> MIN_POOL_SIZE = BasicConfigKey.<Integer>builder()
    ...
    public static final ConfigKey<Integer> MAX_POOL_SIZE = BasicConfigKey.<Integer>builder()
    ...
    public static final ConfigKey<ResizeOperator> RESIZE_OPERATOR = BasicConfigKey.<ResizeOperator>builder()
    ...
    public static final ConfigKey<Function<Entity,Integer>> CURRENT_SIZE_OPERATOR = BasicConfigKey.<Function<Entity,Integer>>builder()
    ...
    public static final ConfigKey<BasicNotificationSensor<? extends Map>> POOL_HOT_SENSOR = BasicConfigKey.<BasicNotificationSensor<? extends Map>>builder()
            .name("autoscaler.poolHotSensor")
            .defaultValue(DEFAULT_POOL_HOT_SENSOR)
            .build();

    @SetFromFlag("poolColdSensor")
    public static final ConfigKey<BasicNotificationSensor<? extends Map>> POOL_COLD_SENSOR = BasicConfigKey.<BasicNotificationSensor<? extends Map>>builder()
            .name("autoscaler.poolColdSensor")
            .defaultValue(DEFAULT_POOL_COLD_SENSOR)
            .build();

    @SetFromFlag("poolOkSensor")
    public static final ConfigKey<BasicNotificationSensor<? extends Map>> POOL_OK_SENSOR = BasicConfigKey.<BasicNotificationSensor<? extends Map>>builder()
            .name("autoscaler.poolOkSensor")
            .defaultValue(DEFAULT_POOL_OK_SENSOR)
            .build();

    @SetFromFlag("maxSizeReachedSensor")
    public static final ConfigKey<BasicNotificationSensor<? super MaxPoolSizeReachedEvent>> MAX_SIZE_REACHED_SENSOR = BasicConfigKey.<BasicNotificationSensor<? super MaxPoolSizeReachedEvent>>builder()
    ...
    public static final ConfigKey<Long> MAX_REACHED_NOTIFICATION_DELAY = BasicConfigKey.<Long>builder()
